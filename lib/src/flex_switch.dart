...
import 'package:flutter/services.dart';
  ...
  class FlexSwitchStyle {
    ...
    /// Label colors (fallback to Theme if null).
    ...
    /// Horizontal space between an [icon] and [label] within a segment.
    final double gap;
    ...
    Widget build(BuildContext context) {
      ...
      return FocusableActionDetector(
        ...
        child: Semantics(
          ...
          value:
              widget.semanticValueBuilder?.call(widget.selectedValue) ??
